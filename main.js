...
data.forEach(producto =>{
    ...
    cards.querySelector('.btn-dark').dataset.id = producto.id
...
const cantidad = Object.values(carrito).reduce((acc, {stock})=> acc + stock,0 )
const precio = Object.values(carrito).reduce((acc,{stock,precio}) => acc + stock * precio ,0)
